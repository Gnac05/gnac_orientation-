...
class AppConstant {
  ...
  static final Map<String, List<String>> carrerList = {
    // A1 and A2
    "A1": [
...
// G2 and G3
  ...
  final Map<String, dynamic> allCourses = {
    "A1": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 5},
      "PHILO": {"Note": 0.0, "Coefficient": 4},
      "HIST-GEO": {"Note": 0.0, "Coefficient": 3},
      "LV1": {"Note": 0.0, "Coefficient": 3},
      "LV2": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 2},
      "SVT": {"Note": 0.0, "Coefficient": 2},
    },
    "A2": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 4},
      "PHILO": {"Note": 0.0, "Coefficient": 3},
      "HIST-GEO": {"Note": 0.0, "Coefficient": 5},
      "LV1": {"Note": 0.0, "Coefficient": 3},
      "LV2": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 2},
      "SVT": {"Note": 0.0, "Coefficient": 2},
    ...
    "B": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 4},
      "PHILO": {"Note": 0.0, "Coefficient": 3},
      "HIST-GEO": {"Note": 0.0, "Coefficient": 4},
      "LV1": {"Note": 0.0, "Coefficient": 2},
      "ECONOMIE": {"Note": 0.0, "Coefficient": 4},
      "MATHS": {"Note": 0.0, "Coefficient": 2},
      "SVT": {"Note": 0.0, "Coefficient": 2},
    },
    "C": {
      "MATHS": {"Note": 0.0, "Coefficient": 6},
      "PCT": {"Note": 0.0, "Coefficient": 5},
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "ANGLAIS": {"Note": 0.0, "Coefficient": 2},
      "SVT": {"Note": 0.0, "Coefficient": 2},
      "HIST-GEO": {"Note": 0.0, "Coefficient": 2},
      "PHILO": {"Note": 0.0, "Coefficient": 2},
    },
    "D": {
      "MATHS": {"Note": 0.0, "Coefficient": 4},
      "PCT": {"Note": 0.0, "Coefficient": 4},
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "ANGLAIS": {"Note": 0.0, "Coefficient": 2},
      "SVT": {"Note": 0.0, "Coefficient": 5},
      "HIST-GEO": {"Note": 0.0, "Coefficient": 2},
      "PHILO": {"Note": 0.0, "Coefficient": 2},
    },
    "E": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 5},
      "PCT": {"Note": 0.0, "Coefficient": 4},
      "CONSTRUCTION MECANIQUE": {"Note": 0.0, "Coefficient": 3},
      "MANIPULATION": {"Note": 0.0, "Coefficient": 3},
      "ETUDE DE FABRICATION": {"Note": 0.0, "Coefficient": 2},
    },
    "G1": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 3},
      "ETUDE DE CAS": {"Note": 0.0, "Coefficient": 4},
      "ECONOMIE": {"Note": 0.0, "Coefficient": 3},
      "ANGLAIS": {"Note": 0.0, "Coefficient": 2},
      "COMPTE-RENDU PV + RAPPORT": {"Note": 0.0, "Coefficient": 3},
    ...
    "G2": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 3},
      "ETUDE DE CAS": {"Note": 0.0, "Coefficient": 6},
      "ECONOMIE": {"Note": 0.0, "Coefficient": 3},
      "ANGLAIS": {"Note": 0.0, "Coefficient": 2},
      "MATHEMAIQUES APPLIQUEES": {"Note": 0.0, "Coefficient": 3},
      "DROIT": {"Note": 0.0, "Coefficient": 2},
    },
    "G3": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 3},
      "ETUDE DE CAS": {"Note": 0.0, "Coefficient": 6},
    ...
    "F1": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 3},
      "PCT": {"Note": 0.0, "Coefficient": 2},
      "CONSTRUCTION MECANIQUE": {"Note": 0.0, "Coefficient": 3},
      "MECANIQUE": {"Note": 0.0, "Coefficient": 2},
      "AUTOMATIQUE": {"Note": 0.0, "Coefficient": 2},
      "ETUDE D'OUTILLAGE": {"Note": 0.0, "Coefficient": 2},
      "ANALYSE DE FABRICATION": {"Note": 0.0, "Coefficient": 3},
    },
    "F2": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 3},
      "PCT": {"Note": 0.0, "Coefficient": 2},
      "CONSTRUCTION MECANIQUE": {"Note": 0.0, "Coefficient": 2},
      "ETUDE D'UN SYSTEME TECHNIQUE": {"Note": 0.0, "Coefficient": 4},
    },
    "F3": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 3},
      "PCT": {"Note": 0.0, "Coefficient": 2},
      "ELECTROTECHNIQUE": {"Note": 0.0, "Coefficient": 3},
      "ETUDE D'UN SYSTEME TECHNIQUE": {"Note": 0.0, "Coefficient": 5},
    },
    "F4": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "MATHS": {"Note": 0.0, "Coefficient": 3},
      "PCT": {"Note": 0.0, "Coefficient": 2},
      "RESISTANCE DES MATERIAUX": {"Note": 0.0, "Coefficient": 3},
      "BETON ARME": {"Note": 0.0, "Coefficient": 2},
      "METRE ET ETUDE DE PRIX": {"Note": 0.0, "Coefficient": 2},
      "PROCEDE DE CONSTRUCTION": {"Note": 0.0, "Coefficient": 2},
    },
    "EA": {
      "FRANCAIS": {"Note": 0.0, "Coefficient": 2},
      "ASSAINISSEMENT": {"Note": 0.0, "Coefficient": 3},
      "MATHS": {"Note": 0.0, "Coefficient": 2},
      "ANGLAIS": {"Note": 0.0, "Coefficient": 3},
      "PCT": {"Note": 0.0, "Coefficient": 2},
      "MOBILISATION DES RESSOURCES EN EAU": {"Note": 0.0, "Coefficient": 2},
      "PROJET D'EXPLOITATION": {"Note": 0.0, "Coefficient": 2},
    }
  };
  ...
  final Map<String, dynamic> allCarrers = {
    "A1": {
      "Lettres et Sciences Humaines": {
        "FLASH-Adjarra": {
          "Ecole/Faculté": "Faculté des Lettres, Arts et Sciences Humaines",
          "Université": "Université d'Abomey-Calavi (UAC)",
          "Bourse": 74,
          "Aide": 446,
          "Matières": ["FRANCAIS", "HIST-GEO", "MATHS"],
          "Métiers": ["Enseignement", "Recherche", "Aménagement du territoire"]
        },
        "FLLAC": {
          "Ecole/Faculté":
          ...
          "Aide": 750,
          "Matières": ["ANGLAIS", "FRANCAIS", "HIST-GEO"],
          "Métiers": ["Interprétariat", "Tourisme", "Enseignement"]
        },
        "FASHS Calavi": {
          "Ecole/Faculté": "Faculté des Sciences Humaines et Sociales",
          "Université": "UAC",
          "Bourse": 44,
          "Aide": 750,
          "Matières": ["FRANCAIS", "PHILO", "HIST-GEO"],
        ...
        "FLASH (UP)": {
          "Ecole/Faculté": "Faculté des Lettres, Arts et Sciences Humaines",
          "Université": "Université de Parakou (UP)",
          "Bourse": 167,
          "Aide": 675,
          "Matières": ["FRANCAIS", "ANGLAIS", "MATHS"],
          "Métiers": ["Enseignement", "Interprétariat", "Tourisme"]
        }
      },
      "Langues": {
        "FLLAC": {
      ...
      "Arts et Culture": {
        "INMAAC": {
          "Ecole/Faculté":
              "Institut National des Métiers d'Arts, d'Archéologie et de la Culture",
          "Université": "UAC",
          "Bourse": 9,
          "Aide": 3,
          "Matières": ["FRANCAIS", "HIST-GEO", "PHILO"],
      ...
      "Droit et Sciences Politiques": {
        "FADESP": {
          "Ecole/Faculté": "Faculté de Droit et de Science Politique",
          "Université": "UAC",
          "Bourse": 120,
          "Aide": 1200,
          "Matières": ["FRANCAIS", "ANGLAIS", "HIST-GEO"],
          "Métiers": ["Droit", "Sciences Politiques"]
        },
        "FDSP (UP)": {
          "Ecole/Faculté": "Faculté de Droit et Sciences Politiques",
          "Université": "UP",
          "Bourse": 111,
          "Aide": 750,
          "Matières": ["FRANCAIS", "PHILO", "HIST-GEO"],
          "Métiers": ["Droit Privé", "Droit Public", "Sciences Politiques"]
        }
      }
    },
    "A2": {
    ...
    "B": {
      "Sciences Economiques et de Gestion": {
        "FASEG": {
          "Ecole/Faculté": "Faculté des Sciences Economiques et de Gestion",
          "Université": "UAC",
          "Bourse": 225,
          "Aide": 1740,
        ...
        "FASEG (UP)": {
          "Ecole/Faculté": "Faculté de Sciences Economiques et de Gestion",
          "Université": "UP",
          "Bourse": 26,
          "Aide": 60,
      ...
      "Gestion": {
        ...
        "IUT (UP)": {
          "Ecole/Faculté": "Institut Universitaire de Technologie",
          "Université": "UP",
          "Bourse": 9,
          "Aide": 3,
          "Matières": ["MATHS", "FRANCAIS", "ANGLAIS"],
      ...
      "Commerce International": {
        "HERCI": {
          "Ecole/Faculté": "Haute Ecole Réginale de Commerce International",
          "Université": "UAC",
          "Bourse": 9,
          "Aide": 3,
    ...
    "C": {
      "Sciences et Technologies": {
        "FAST": {
          "Ecole/Faculté": "Faculté des Sciences Techniques",
          "Université": "UAC",
          "Bourse": 74,
          "Aide": 300,
          "Matières": ["SVT", "PCT", "FRANCAIS"],
        ...
        "FAST Natitingou": {
          "Ecole/Faculté": "Faculté des Sciences et Techniques",
          "Université": "UNSTIM",
          "Bourse": 105,
          "Aide": 75,
          "Matières": ["ANGLAIS", "PCT", "MATHS"],
          "Métiers": ["Mathématiques Informatiques", "Physique Chimie"]
        }
      },
      "Santé": {
        "FSS": {
          "Ecole/Faculté": "Faculté des Sciences de la Santé",
          "Université": "UAC",
          "Bourse": 150,
          "Aide": 10,
          "Matières": ["MATHS", "PCT", "SVT"],
          "Métiers": ["Médecine Générale", "Pharmacie", "Kinésithérapie"]
        },
        "FM (UP)": {
          "Ecole/Faculté": "Faculté de Médecine",
          "Université": "UP",
          "Bourse": 120,
          "Aide": 33,
          "Matières": ["MATHS", "PCT", "SVT"],
          "Métiers": ["Médecine Humaine"]
        }
      },
      "Génie": {
        "EPAC": {
          "Ecole/Faculté": "Ecole Polytechnique d'Abomey-Calavi",
          "Université": "UAC",
          "Bourse": 28,
          "Aide": 7,
          "Matières": ["MATHS", "PCT", "ANGLAIS"],
        ...
        "ENSTP": {
          "Ecole/Faculté": "Ecole Nationale Supérieure des Travaux Publics",
          "Université": "UNSTIM",
          "Bourse": 24,
          "Aide": 4,
          "Matières": ["MATHS", "ANGLAIS", "PCT"],
      ...
      "Agronomie": {
        "FSA": {
          "Ecole/Faculté": "Faculté des Sciences Agronomiques",
          "Université": "UAC",
          "Bourse": 14,
          "Aide": 3,
          "Matières": ["MATHS", "PCT", "SVT"],
        ...
        "FA (UP)": {
          "Ecole/Faculté": "Faculté d'Agronomie",
          "Université": "UP",
          "Bourse": 22,
          "Aide": 6,
          "Matières": ["MATHS", "PCT", "SVT"],
    ...
    "E": {
      ...
      "Energies Renouvelables": {
        "FAST": {
          ...
          "Aide": 6,
          "Matières": ["MATHS", "PCT", "FRANCAIS"],
          "Métiers": ["Energies Renouvelables et Systèmes Energétiques"]
        },
        "INSTI": {
          "Ecole/Faculté":
              "Institut National Supérieur de Technologie Industrielle",
    ...
    "G1": {
      "Gestion": {
        ...
        "IUT (UP)": {
          ...
          "Aide": 3,
          "Matières": ["ETUDE DE CAS", "FRANCAIS", "ANGLAIS"],
          "Métiers": ["Gestion Commerciale", "Gestion des Ressources Humaines"]
        }
      },
      "Droit et Sciences Politiques": {
        "FADESP": {
      ...
      "Communication": {
        "FLLAC": {
          ...
          "Aide": 375,
          "Matières": ["ANGLAIS", "FRANCAIS", "ETUDE DE CAS"],
          "Métiers": ["Sciences du Langage et de la Communication"]
        }
      }
    },
    "G2": {
